...
/**
 */
public class DeleteByQueryAction extends Action<DeleteByQueryRequest, DeleteByQueryResponse, DeleteByQueryRequestBuilder, SearchClient> {
    ...
    @Override
    public DeleteByQueryRequestBuilder newRequestBuilder(SearchClient client) {
