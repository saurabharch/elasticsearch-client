...
/**
 */
public class CountAction extends Action<CountRequest, CountResponse, CountRequestBuilder, SearchClient> {
    ...
    @Override
    public CountRequestBuilder newRequestBuilder(SearchClient client) {
