...
/**
 */
public class MultiSearchAction extends Action<MultiSearchRequest, MultiSearchResponse, MultiSearchRequestBuilder, SearchClient> {
    ...
    @Override
    public MultiSearchRequestBuilder newRequestBuilder(SearchClient client) {
