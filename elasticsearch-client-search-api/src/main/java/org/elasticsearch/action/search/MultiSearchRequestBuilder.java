 ...
 */
public class MultiSearchRequestBuilder extends BaseSearchRequestBuilder<MultiSearchRequest, MultiSearchResponse> {

    public MultiSearchRequestBuilder(SearchClient client) {
