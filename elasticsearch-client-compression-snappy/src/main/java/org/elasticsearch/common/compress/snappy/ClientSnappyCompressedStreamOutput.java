...
/**
 */
public abstract class ClientSnappyCompressedStreamOutput extends CompressedStreamOutput<SnappyCompressorContext> {

    protected final BufferRecycler recycler;

    protected byte[] compressedBuffer;

    public ClientSnappyCompressedStreamOutput(StreamOutput out, SnappyCompressorContext context) throws IOException {
        super(out, context);
    ...
    public void writeHeader(StreamOutput out) throws IOException {
        out.writeBytes(ClientSnappyCompressor.HEADER);
