...
/**
 */
public class ClientThreadPoolStats implements ThreadPoolStats {
    ...
    public ClientThreadPoolStats(List<ThreadPoolStatsElement> stats) {
        this.stats = stats;
    }
    ...
    public static ThreadPoolStats readThreadPoolStats(StreamInput in) throws IOException {
        ThreadPoolStats stats = new ClientThreadPoolStats();
        stats.readFrom(in);
        return stats;
    }
    ...
    public void readFrom(StreamInput in) throws IOException {
        ...
        for (int i = 0; i < size; i++) {
            ThreadPoolStatsElement stats1 = new ClientThreadPoolStatsElement();
            stats1.readFrom(in);
            stats.add(stats1);
        }
    }
