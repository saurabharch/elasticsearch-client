...
/**
 */
public class IndicesGetAliasesAction extends ClusterAction<IndicesGetAliasesRequest, IndicesGetAliasesResponse, IndicesGetAliasesRequestBuilder> {
    ...
    @Override
    public IndicesGetAliasesRequestBuilder newRequestBuilder(ClusterAdminClient client) {
