...
import org.elasticsearch.common.settings.ClientSettingsFilter;
...
public class IndicesStatusResponse extends BroadcastOperationResponse implements ToXContent {
    ...
    public XContentBuilder toXContent(XContentBuilder builder, Params params, @Nullable ClientSettingsFilter settingsFilter) throws IOException {
