...
import org.elasticsearch.threadpool.client.ClientThreadPoolInfo;
...
public class NodeInfo extends NodeOperationResponse {
    ...
    @Nullable
    protected ImmutableMap<String, String> serviceAttributes;
    ...
    @Nullable
    protected ProcessInfo process;

    @Nullable
    protected JvmInfo jvm;

    @Nullable
    protected ThreadPoolInfo threadPool;

    @Nullable
    protected NetworkInfo network;

    @Nullable
    protected TransportInfo transport;

    @Nullable
    protected HttpInfo http;
