...
import org.elasticsearch.threadpool.client.ClientThreadPoolStats;
...
public class NodeStats extends NodeOperationResponse {
    ...
    @Nullable
    protected NodeIndicesStats indices;

    @Nullable
    protected OsStats os;

    @Nullable
    protected ProcessStats process;

    @Nullable
    protected JvmStats jvm;

    @Nullable
    protected ThreadPoolStats threadPool;

    @Nullable
    protected NetworkStats network;

    @Nullable
    protected FsStats fs;

    @Nullable
    protected TransportStats transport;

    @Nullable
    protected HttpStats http;
