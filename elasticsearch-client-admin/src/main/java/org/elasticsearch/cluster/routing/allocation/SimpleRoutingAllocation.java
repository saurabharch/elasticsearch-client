 ...
 *
 */
public class SimpleRoutingAllocation implements RoutingAllocation {
    ...
    public SimpleRoutingAllocation(AllocationDeciders deciders, RoutingNodes routingNodes, DiscoveryNodes nodes) {
