...
import org.elasticsearch.threadpool.TransportThreadPoolInfo.Fields;

public class TransportThreadPoolInfo implements Streamable, Iterable<TransportThreadPoolInfo.Info>, ToXContent {
    ...
    public TransportThreadPoolInfo(List<Info> infos) {
        this.infos = infos;
    }
