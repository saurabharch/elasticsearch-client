...
/**
 */
public class UpdateAction extends Action<UpdateRequest, UpdateResponse, UpdateRequestBuilder, IngestClient> {
    ...
    @Override
    public UpdateRequestBuilder newRequestBuilder(IngestClient client) {
