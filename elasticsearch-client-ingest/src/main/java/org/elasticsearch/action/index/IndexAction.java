...
/**
 */
public class IndexAction extends Action<IndexRequest, IndexResponse, IndexRequestBuilder, IngestClient> {
    ...
    @Override
    public IndexRequestBuilder newRequestBuilder(IngestClient client) {
