 ...
 *
 */
public class ClientCachedStreamInput {
    ...
    public static StreamInput compressed(BasicCompressor compressor, StreamInput in) throws IOException {
    ...
    public static HandlesStreamInput cachedHandlesCompressed(BasicCompressor compressor, StreamInput in) throws IOException {
