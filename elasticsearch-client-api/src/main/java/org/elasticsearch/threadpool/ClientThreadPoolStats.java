...
/**
 */
public class ClientThreadPoolStats implements Streamable, ToXContent, Iterable<ClientThreadPoolStats.Stats> {
    ...
    ClientThreadPoolStats() {

    }

    public ClientThreadPoolStats(List<Stats> stats) {
        this.stats = stats;
    }
    ...
    public static ClientThreadPoolStats readThreadPoolStats(StreamInput in) throws IOException {
        ClientThreadPoolStats stats = new ClientThreadPoolStats();
        stats.readFrom(in);
        return stats;
    }
