...
public enum OperationStatus {
    ...
    public static OperationStatus readFrom(StreamInput in) throws IOException {
        return OperationStatus.valueOf(in.readString());
    }

    public static void writeTo(StreamOutput out, OperationStatus status) throws IOException {
