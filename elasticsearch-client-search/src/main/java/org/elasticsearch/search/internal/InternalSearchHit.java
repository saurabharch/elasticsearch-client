...
import static org.elasticsearch.common.lucene.client.Lucene.readExplanation;
import static org.elasticsearch.common.lucene.client.Lucene.writeExplanation;
...
public class InternalSearchHit implements SearchHit {
    ...
    public XContentBuilder toXContent(XContentBuilder builder, Params params) throws IOException {
        ...
        if (source != null) {
            restDocumentSource(source, builder, params);
        }
    ...
    public static void restDocumentSource(BytesReference source, XContentBuilder builder, ToXContent.Params params) throws IOException {
        BasicCompressor compressor = BasicCompressorFactory.compressor(source);
        if (compressor != null) {
