 ...
 */
public class ExplainAction extends Action<ExplainRequest, ExplainResponse, ExplainRequestBuilder, SearchClient> {
    ...
    public ExplainRequestBuilder newRequestBuilder(SearchClient client) {
