...
/**
 */
public class PercolateAction extends Action<PercolateRequest, PercolateResponse, PercolateRequestBuilder, IngestClient> {
    ...
    @Override
    public PercolateRequestBuilder newRequestBuilder(IngestClient client) {
