...
/**
 */
public class MultiGetAction extends Action<MultiGetRequest, MultiGetResponse, MultiGetRequestBuilder, IngestClient> {
    ...
    @Override
    public MultiGetRequestBuilder newRequestBuilder(IngestClient client) {
