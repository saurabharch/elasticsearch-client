...
/**
 */
public class BulkAction extends Action<BulkRequest, BulkResponse, BulkRequestBuilder, IngestClient> {
    ...
    @Override
    public BulkRequestBuilder newRequestBuilder(IngestClient client) {
