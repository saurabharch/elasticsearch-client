 ...
 * under the License.
 */
package org.elasticsearch.http.action.admin.indices.template.put;
...
public class HttpPutIndexTemplateAction extends HttpAction<PutIndexTemplateRequest, PutIndexTemplateResponse> {
    ...
    @Override
    protected PutIndexTemplateResponse toResponse(HttpResponse response) throws IOException {
