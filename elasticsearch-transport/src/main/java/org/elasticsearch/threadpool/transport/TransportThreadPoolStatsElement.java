...
public class TransportThreadPoolStatsElement implements ThreadPoolStatsElement {
    ...
    TransportThreadPoolStatsElement() {
    }

    public TransportThreadPoolStatsElement(String name, int threads, int queue, int active, long rejected) {
        this.name = name;
