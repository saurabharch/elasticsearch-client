...
/**
 */
public class TransportThreadPoolStats implements Streamable, ToXContent, Iterable<TransportThreadPoolStats.Stats> {
    ...
    public TransportThreadPoolStats(List<Stats> stats) {
        this.stats = stats;
    }
