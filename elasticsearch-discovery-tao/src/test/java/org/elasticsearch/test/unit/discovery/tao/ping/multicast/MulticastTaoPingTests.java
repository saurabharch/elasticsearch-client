...
public class MulticastTaoPingTests extends Assert {
    ...
    public void testSimplePings() {
        ...
        final ClientTransportService transportServiceA = new ClientTransportService(new LocalClientTransport(threadPool), threadPool).start();
        final DiscoveryNode nodeA = new DiscoveryNode("A", transportServiceA.boundAddress().publishAddress());

        final ClientTransportService transportServiceB = new ClientTransportService(new LocalClientTransport(threadPool), threadPool).start();
